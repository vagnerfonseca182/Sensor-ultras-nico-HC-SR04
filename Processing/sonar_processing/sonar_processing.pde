...
void setup() {
  ...
  size (1250, 700); /* ***Alterar para resolução que desejar*** */
  smooth();
  myPort = new Serial(this, "COM3", 9600); /* inicia comunicação serial. */
  ...
  player = minim.loadFile("SonarEffect.mp3");
  player.rewind();
...
void drawText() { /* desenha os textos na tela. */
  ...
  textSize(20);
  text("IFTM ADS 2°P", width*0.0229, height*0.0833);
  text("Vagner Fonseca", width*0.0100, height*0.1200);
  fill(98, 245, 60);
